...
import grade5 from '../../assets/grade5.jpg';
import grade6 from '../../assets/grade6.jpeg';
import grade7 from '../../assets/grade7.jpg';
import grade8 from '../../assets/grade8.jpg';
import grade9 from '../../assets/grade9.jpg';
                    ...
                    <Stack divider={<StackDivider />} spacing='4'>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Heading className='research-card-heading'>
                                Учебники «Русский язык. 5-9 классы» под общ. ред. акад. РАО Г.Г. Граник
                            </Heading>
                            ...
                            <Accordion defaultIndex={[0]} allowMultiple>
                                <AccordionItem>
                                    ...
                                    <AccordionPanel pb={4} >
                                        ...
                                        <Text className='research-accordion-text'>
                                            <b>Русский язык. 5 класс: учебник для общеобразовательных организаций. В 3 ч. / Г.Г. Граник, Н.А. Борисенко, С. М. Бондаренко, С. В. Шишкова; под общ. ред. Г. Г. Граник. 8-е изд., перераб. М.: Мнемозина, 2023.</b>
                                        </Text>
                                        <Text className='research-accordion-text'>
                                            Учебник входит в УМК, реализующий идею преемственности образования с 1-го по 9-й класс и обеспечивающий достижение главной цели изучения русского языка — воспитание культурного человека, свободно владеющего грамотной устной и письменной речью.
                                        </Text>
                                        <Text className='research-accordion-text'>
                                            Фундаментом курса, ориентированного на формирование устойчивого познавательного интереса и позволяющего привить осознанную любовь к изучаемому предмету, является синтаксис. Другие разделы лингвистики даются на его основе. Раздел «Синтаксис и пунктуация» включает повторение изученного в начальной школе о простом предложении и новые темы (простые и сложные предложения, виды сложных предложений, графический разбор предложения, сложные предложения-«гуси» и сложные предложения-«матрешки» и др.). Кроме синтаксиса, часть 1 учебника содержит систематический курс фонетики, графики и орфографии. В части 2, посвященной морфемике и орфографии, дается общее понятие о составе слова, о смысловых или грамматических функциях морфем. Подробно рассматривается корень, изучаются правила написания корней и приставок. Часть 3 содержит словарики разных типов и ответы к заданиям из первой и второй частей учебника.
                                        </Text>
                                        <Text className='research-accordion-text'>
                                            Содержание учебника соответствует требованиям ФГОС 2021 г., Примерной основной образовательной программы ООО, Примерной рабочей программы ООО «Русский язык» и направлено на реализацию Концепции преподавания русского языка и литературы в РФ.
                                        </Text>
                                    </AccordionPanel>
                                </AccordionItem>
                                <AccordionItem>
                                    ...
                                    <AccordionPanel pb={4}>
                                        <Image
                                            ...
                                            float={'left'}
                                            marginRight={{ base: 3, sm: 4, md: '5', xl: '6' }}
                                            maxW={{ base: '100px', sm: '120px', md: '140px', lg: '170px', xl: '200px' }}
                                            objectFit='contain'
                                            src={grade6}
                                            alt='Учебник 6-го класса'
                                        />
                                        <Text className='research-accordion-text'>
                                            <b>Русский язык. 6 класс: учебник для общеобразовательных организаций. В 3 ч. / Г.Г. Граник, Н.А. Борисенко, Г.Н. Владимирская, С.М. Бондаренко; под общ. ред. Г. Г. Граник. 6-е изд., перераб. М.: Мнемозина, 2023.</b>
                                        </Text>
                                        <Text className='research-accordion-text'>
                                            Учебник входит в УМК, реализующий идею преемственности образования с 1-го по 9-й класс и обеспечивающий достижение главной цели изучения русского языка — воспитание культурного человека, свободно владеющего грамотной устной и письменной речью.   Первая часть учебника содержит повторение основного материала курса 5-го класса; подробно изучаются словообразование, лексика и фразеология, морфология (глагол и имя существительное). Во второй части рассматриваются имя прилагательное, имя числительное, местоимение; на новом витке спирали изучается синтаксис (понятие о предложении, главные члены, включая виды сказуемого и подлежащего, второстепенные члены). Часть 3 содержит словарики разных типов и ответы к заданиям из первой и второй частей учебника.
                                        </Text>
                                        <Text className='research-accordion-text'>
                                            Содержание учебника соответствует требованиям ФГОС, Примерной основной образовательной программы ООО и направлено на реализацию Концепции преподавания русского языка и литературы в РФ.
                                        </Text>
                                    </AccordionPanel>
                                </AccordionItem>
                                <AccordionItem>
                                    ...
                                    <AccordionPanel pb={4}>
                                        ...
                                        />
                                        <Text className='research-accordion-text'>
                                            <b>Русский язык. 7 класс: учебник для общеобразовательных организаций. В 3 ч. / Г.Г. Граник, Н.А. Борисенко, Г.Н. Владимирская; под общ. ред. Г. Г. Граник. 4-е изд. М.: Мнемозина, 2017.</b>
                                        </Text>
                                        <Text className='research-accordion-text'>
                                            Учебник входит в новый УМК, реализующий идею преемственности образования с 1-го по 9-й класс и обеспечивающий достижение главной цели изучения русского языка - воспитание культурного человека, свободно владеющего грамотной устной и письменной речью. Первая часть учебника содержит сведения о тексте, стилях речи; двусоставных и односоставных, полных и неполных предложениях. Рассматриваются также слова, грамматически не связанные с предложением (обращения, междометия, слова-предложения да и нет, вводные слова, словосочетания и предложения). Начинается изучение такой самостоятельной части речи, как наречие. Во второй части учебника рассматриваются глагольные формы: деепричастие и причастие. Изучение морфологии органически переплетено с синтаксисом и пунктуацией: вводится понятие обособления, формируется представление об обособленных членах предложения (обстоятельствах, определениях, приложениях). Третья часть содержит словарики разных типов и ответы к заданиям из первой и второй частей учебника.
                                        </Text>
                                        <Text className='research-accordion-text'>
                                            Содержание учебника соответствует требованиям ФГОС, Примерной основной образовательной программы ООО и направлено на реализацию Концепции преподавания русского языка и литературы в РФ.
                                        </Text>
                                ...
                                <AccordionItem>
                                    ...
                                    <AccordionPanel pb={4}>
                                        ...
                                        />
                                        <Text className='research-accordion-text'>
                                            <b>Русский язык. 8 класс: учебник для общеобразовательных организаций. В 3 ч. / Г.Г. Граник, Н.А. Борисенко, Г.Н. Владимирская; под общ. ред. Г. Г. Граник. 3-е изд. М.: Мнемозина, 2013.</b>
                                        </Text>
                                        <Text className='research-accordion-text'>
                                            Учебник входит в новый УМК, реализующий идею преемственности образования с 1-го по 9-й класс и обеспечивающий достижение главной цели изучения русского языка - воспитание культурного человека, свободно владеющего грамотной устной и письменной речью. Первая часть учебника содержит повторение по теме «Осложненное предложение», затем подробно изучаются служебные части речи: предлог, союз, частица, их правописание и употребление. Вторая часть посвящена синтаксису и пунктуации, в том числе (в этом состоит одна из особенностей курса Г.Г. Граник) сложному предложению (сложносочиненное предложение, сложноподчиненное предложение, сложное предложение с разными видами связи). Изучение данного раздела в 8-м классе обеспечивает раннюю подготовку к ОГЭ и высвобождает время для повторения и обобщения изученных ранее тем в 9-м классе. Часть третья содержит словарики разных типов и ответы к заданиям из первой и второй частей учебника.
                                        </Text>
                                    </AccordionPanel>
                                </AccordionItem>
                                <AccordionItem>
                                    ...
                                    <AccordionPanel pb={4}>
                                        <Image
                                            ...
                                            float={'left'}
                                            marginRight={{ base: 3, sm: 4, md: '5', xl: '6' }}
                                            maxW={{ base: '100px', sm: '130px', md: '160px', lg: '180px', xl: '210px' }}
                                            objectFit='contain'
                                            src={grade9}
                                            alt='Учебник 9-го класса'
                                        />
                                        <Text className='research-accordion-text'>
                                            <b>Русский язык. 9 класс: учебник для общеобразовательных организаций. В 2 ч. / Г.Г. Граник, Н.А. Борисенко, Г.Н. Владимирская; под общ. ред. Г. Г. Граник. М.: Мнемозина, 2013.</b>
                                        </Text>
                                        <Text className='research-accordion-text'>
                                            Данный учебник — заключительная часть предметной линии под редакцией Г. Г. Граник. Основное содержание учебника составляет изучение сложного предложения. Учебник также содержит главы «Общие сведения о русском языке», «Текст, речеведение, культура речи». Объемный блок повторения включает материал по всем разделам науки о русском языке, тексты для изложений, тренировочные задания и тесты, направленные на подготовку к ОГЭ. Текстоцентрический принцип, лежащий в основе учебника, позволяет систематически работать над пониманием текста, развитием воображения и творческих способностей учащихся. Вторая часть содержит словарики разных типов и ответы к заданиям.
                                        </Text>
                                    </AccordionPanel>
                                </AccordionItem>
                            </Accordion>
