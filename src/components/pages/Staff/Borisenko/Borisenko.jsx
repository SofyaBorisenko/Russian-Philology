  ...
  return (
    <div>
      ...
      <article className='staff-article'>
        <p>
          Борисенко Наталья Анатольевна – ведущий научный сотрудник
          ...
          коллектива УМК «Русский язык. 5–9 классы» под науч. руков. акад. РАО
          Г.Г. Граник, лауреат премии Правительства Российской Федерации в
          области образования за создание УМК по курсу «Русский язык и
          литературное чтение» для общеобразовательных учреждений» (2008),
          вице-президент Русской ассоциации чтения, член Союза журналистов
          Москвы.
        </p>
        <p>
          Автор свыше 250 публикаций в научных («Вопросы психологии»,
